...
const menuItemClassName =
  "py-2 px-5 text-base text-simplybook-gray border-transparent [&.active]:font-semibold [&.active]:text-tertiary hover:border-gray-500 hover:bg-gray-100 focus:outline-hidden";
