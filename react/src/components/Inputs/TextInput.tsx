        ...
        return (
            <>
                <input
                    ref={ref}
                    type={type}
                    className={`w-full rounded-md border border-gray-300 p-2 focus:border-tertiary focus:outline-hidden focus:ring disabled:cursor-not-allowed disabled:border-gray-200 disabled:bg-gray-200 ${className || ""}`}
                    onClick={handleClick}
                    {...props}
                />
            {copiedFeedback &&
