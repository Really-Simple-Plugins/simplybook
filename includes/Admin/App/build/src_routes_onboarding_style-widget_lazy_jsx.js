...
const Route = (0,_tanstack_react_router__WEBPACK_IMPORTED_MODULE_10__.createLazyFileRoute)(path)({
  component: React.memo(() => {
    ...
    const [prevOnboardingCompleted, setPreviousOnboardingCompleted] = (0,react__WEBPACK_IMPORTED_MODULE_3__.useState)(true);
    const runInlineScript = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async () => {
    ...
    const setupPreview = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(async () => {
      if (isLoadingScript) {
        return;
      }
    ...
    const clearInlineScript = (0,react__WEBPACK_IMPORTED_MODULE_3__.useCallback)(() => {
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_3__.useEffect)(() => {
      ...
      console.log("isSavingSettings, onboardingcompleted UseEffect ", isSavingSettings, onboardingCompleted);
      if (!onboardingCompleted) {
        return;
      }
      if (isSavingSettings) {
