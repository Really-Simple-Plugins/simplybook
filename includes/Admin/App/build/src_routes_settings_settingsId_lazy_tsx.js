"use strict";
(self["webpackChunksimplybook_app"] = self["webpackChunksimplybook_app"] || []).push([["src_routes_settings_settingsId_lazy_tsx"],{
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _tanstack_react_query__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @tanstack/react-query */ "./node_modules/@tanstack/react-query/build/modern/useQuery.js");
Object(function webpackMissingModule() { var e = new Error("Cannot find module '../routes/settings/$settingsId'"); e.code = 'MODULE_NOT_FOUND'; throw e; }());
...
const useSettingsMenu = () => {
  const {
    settingsId
  } = Object(function webpackMissingModule() { var e = new Error("Cannot find module '../routes/settings/$settingsId'"); e.code = 'MODULE_NOT_FOUND'; throw e; }()).useParams();
  // Query for fetching settings from server
...
function Settings() {
  ...
  console.log(currentSection.groups);
  if (menuIsLoading) {
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.Fragment, {
    children: [currentSection.groups && currentSection.groups.map(function (group) {
      ...
      console.log(group.id, className);
...
//# sourceMappingURL=src_routes_settings_settingsId_lazy_tsx.js.map