...
const Header = () => {
  ...
  if ($[4] === Symbol.for("react.memo_cache_sentinel")) {
    t3 = /*#__PURE__*/React.createElement(_tanstack_react_router__WEBPACK_IMPORTED_MODULE_6__.Link, {
      to: "/",
      className: "py-6 px-5 border-b-4  border-transparent [&.active]:border-tertiary focus:outline-none"
...
const LoginLink = t0 => {
  ...
  let t3;
  if ($[0] !== alreadyLoggedIn || $[1] !== directUrl || $[2] !== fetchLinkData || $[3] !== loginUrl || $[4] !== loginUrlFetched || $[5] !== setAlreadyLoggedIn) {
    t3 = async (e, page_0) => {
      e.preventDefault();
      let link = alreadyLoggedIn ? directUrl : loginUrl;
      console.log("Get login URL for", page_0);
      if (!loginUrlFetched) {
      ...
      const finalUrl = alreadyLoggedIn ? `${link}/${page_0}` : `${link}?back_url=/${page_0}/`;
  ...
  if (isButton) {
    ...
    let t6;
    if ($[10] !== btnVariant || $[11] !== children || $[12] !== combinedClassName || $[13] !== size || $[14] !== t4 || $[15] !== t5) {
...
/* harmony import */ var _Inputs_PaletteInput__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../Inputs/PaletteInput */ "./src/components/Inputs/PaletteInput.tsx");
/* harmony import */ var _Forms_FormField__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../Forms/FormField */ "./src/components/Forms/FormField.js");
...
const PalettesField = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_1__.forwardRef)((t0, ref) => {
  ...
  let t3;
  if ($[8] !== props.onChange || $[9] !== props.value || $[10] !== setting.options) {
    let t4;
    if ($[12] !== props.onChange || $[13] !== props.value) {
      t4 = (option, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Inputs_PaletteInput__WEBPACK_IMPORTED_MODULE_5__["default"], {
        key: index,
        id: option.id,
        label: option.label,
  ...
  if ($[15] !== className || $[16] !== context || $[17] !== help || $[18] !== inputId || $[19] !== label || $[20] !== props.required || $[21] !== t1 || $[22] !== t3) {
    t4 = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_Forms_FieldWrapper__WEBPACK_IMPORTED_MODULE_3__["default"], {
      label: label,
      help: help,
      error: t1,
      context: context,
...
const FormField = /*#__PURE__*/(0,react__WEBPACK_IMPORTED_MODULE_5__.memo)(({
  ...
  return /*#__PURE__*/React.createElement(_components_Common_ErrorBoundary__WEBPACK_IMPORTED_MODULE_4__["default"], null, /*#__PURE__*/React.createElement(react_hook_form__WEBPACK_IMPORTED_MODULE_12__.Controller, {
    name: setting.id,
    control: control,
...
const useOnboardingData = () => {
  ...
  const handleCalendarPageNameChange = pageName_2 => {
    setCalendarPageName(pageName_2);
...
const useSettingsData = () => {
  ...
  if ($[4] !== query.data || $[5] !== queryClient) {
    t3 = (id_0, value) => {
      ...
      queryClient.setQueryData(["settings_fields"], oldData => oldData.map(field_3 => field_3.id === id_0 ? {
        ...field_3,
        value
      } : field_3));
    };
  ...
  let t8;
  if ($[12] !== getValue || $[13] !== query.data || $[14] !== saveSettings || $[15] !== setValue || $[16] !== t6 || $[17] !== t7) {
    t8 = {
      settings: query.data,
      saveSettings,
      getValue,
  ...
  return (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
    ...
    children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("p", {
      ...
      children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div", {
        ...
        className: "flex items-center space-x-2 text-indigo-600 cursor-pointer",
        children: [(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("svg", {
          ...
          children: value === id ? 'live' : 'preview'
        })]
      })]
    })]
  });
