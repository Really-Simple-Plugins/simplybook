...
/* harmony export */   getEmbedData: () => (/* binding */ getEmbedData)
/* harmony export */ });
...
/**
 * BLOCK: Simplybook embed block
 *
 * Registering the Simplybook widget
 */
...
// SVG icon
const iconEl = () => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Icon, {
  icon: (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
    id: "uuid-098657ec-4091-4c5d-b2f8-761b37dc9655",
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 22 19.26"
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("path", {
    className: "uuid-fb9dd603-42c0-4281-8513-899f01887edf",
...
const selectEmbed = ({
  ...
  const [embedData, setEmbedData] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)([]);
  const [embedHtml, setEmbedHtml] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(__('Loading...', 'simplybook'));
  const [dataLoaded, setDataLoaded] = (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useState)(false);
  (0,_wordpress_element__WEBPACK_IMPORTED_MODULE_2__.useEffect)(() => {
    _utils_api__WEBPACK_IMPORTED_MODULE_1__.getEmbedData().then(response => {
      console.log(response);
      let embedData = response;
      console.log("loaded embed data", embedData);
  ...
  if (attributes.preview) {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("img", {
      alt: "preview",
      src: simplybook.preview
    });
  }
  return [(0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    className: className,
    dangerouslySetInnerHTML: {
      __html: dompurify__WEBPACK_IMPORTED_MODULE_3___default().sanitize(embedHtml)
    }
  })];
};
...
registerBlockType('simplybook/embed', {
  ...
  keywords: [__('Booking, Reservation system, Meeting', 'simplybook')],
