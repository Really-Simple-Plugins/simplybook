...
<style>
    ...
    .rsp-complete-onboarding .rsp-complete-onboarding-form button.rsp-link {
        background: none;
        border: none;
        color: #2271b1;
...
<div id="message" class="updated fade notice is-dismissible rsp-complete-onboarding simplybook-notice" data-notice-type="complete_onboarding">
